...
public class Exit extends Command {
     ...
     */
    public Exit(String arguments, Text text, TextFormatter textFormatter) throws InvalidInputException {
     ...
     * {@inheritDoc}
     *
     * @return {@link SubsequentAction#EXIT}
     */
    @Override
    public SubsequentAction getSubsequentAction() {
        return SubsequentAction.EXIT;
    }
